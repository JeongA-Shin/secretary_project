...
const ColumnContainer = tw.div`lg:w-2/12 max-w-lg`;
...
const DecoratorBlob2 = tw(
  SvgDecoratorBlob1
)`absolute top-0 right-0 right-0 w-80 h-80 transform  translate-x-20 -translate-y-64 text-primary-500 opacity-5`;
export default ({
  primaryLinkText = "ON",
  primaryLinkUrl = "http://google.com",
  secondaryLinkText = "OFF",
